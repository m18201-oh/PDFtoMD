...
- [USER_GUIDE.md](./doc/USER_GUIDE.md): 비개발자가 가장 짧고 쉽게 전체 사용 흐름을 파악하기 위한 안내 문서
- [OPERATIONS_MANUAL.md](./doc/OPERATIONS_MANUAL.md): 운영자가 현재 상태를 판단하고 문제에 대응하기 위한 실무 문서
- [RELEASE_CHECKLIST.md](./doc/RELEASE_CHECKLIST.md): 다른 PC 배포 전후에 확인할 항목을 정리한 문서
- [QUICK_DEPLOY.md](./doc/QUICK_DEPLOY.md): 설치 담당자가 짧은 순서대로 바로 따라 하는 실행용 문서
- [project_init_workflow.md](./doc/project_init_workflow.md): 초기 세팅 과정을 기록한 참고 문서
- [PDFtoMD_PRD_v2.2.docx](./doc/PDFtoMD_PRD_v2.2.docx): 요구사항 정의서
- [PDFtoMD_Playbook_v1.0.docx](./doc/PDFtoMD_Playbook_v1.0.docx): 구현 플레이북
...
│  ├─ PDFtoMD_PRD_v2.2.docx
│  └─ PDFtoMD_Playbook_v1.0.docx
├─ 01_watch_inbox/
├─ 02_workspace/
├─ 03_rejected/
├─ 04_done/
...
- 최종 Markdown, 원본 PDF, 작업 브리핑 Markdown을 `04_done/` 폴더에 보관
- `docuConverter01` 메트릭을 기반으로 페이지당 평균 처리시간을 기록
- 진행 로그는 `05_logs/run.log`, 오류 로그는 `05_logs/error.log`에 기록
...
4. `C:\Code\PDFtoMD\01_watch_inbox`, `02_workspace`, `03_rejected`, `04_done`, `05_logs` 폴더 생성 가능
...
- [OPERATIONS_MANUAL.md](./doc/OPERATIONS_MANUAL.md)
- [RELEASE_CHECKLIST.md](./doc/RELEASE_CHECKLIST.md)
- [QUICK_DEPLOY.md](./doc/QUICK_DEPLOY.md)
